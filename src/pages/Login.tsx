  ...
  return (
    <div className="min-h-screen">
      <div className="app-shell px-6 py-8">
        ...
        <Button onClick={() => toast.error("Google sign in is coming soon. Please use email and password.")} variant="outline" size="lg" className="w-full h-12 rounded-xl bg-surface hover:bg-surface-elevated border-border">
